        ...
        <div className="grid grid-cols-12 items-end gap-3">
          <div className="col-span-12 flex items-center gap-2 text-xs text-zinc-400">
            ...
            <span className="group relative inline-flex">
              ...
              <div className="pointer-events-none absolute bottom-full left-full z-50 mb-2 ml-2 hidden w-80 rounded-2xl bg-zinc-950/95 p-3 text-xs text-zinc-200 opacity-0 shadow-xl ring-1 ring-white/10 backdrop-blur transition group-hover:block group-hover:opacity-100">
